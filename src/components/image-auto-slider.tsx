...
export const ImageAutoSlider = () => {
  ...
  return (
    <>
      ...
      <div className="w-full min-h-64 relative overflow-hidden flex items-center justify-center">
        {/* Scrolling images container */}
        <div className="relative z-10 w-full flex items-center justify-center py-4">
          <div className="scroll-container w-full max-w-4xl">
            <div className="infinite-scroll flex gap-2 w-max">
              {duplicatedImages.map((image, index) => (
                <div
                  key={index}
                  className="image-item flex-shrink-0 w-24 h-24 md:w-32 md:h-32 rounded-lg overflow-hidden shadow-lg"
                >
                  <img
                    src={image}
